...
## 🎯 Goal
Configure Cloudflare Tunnel to expose your Docker deployment at: https://seo-expert.theprofitplatform.com.au
...
**Full URL will be**: `https://seo-expert.theprofitplatform.com.au`

**Advanced settings** (optional but recommended):
- **HTTP Host Header**: Leave blank or set to `seo-expert.theprofitplatform.com.au`
...
```bash
curl https://seo-expert.theprofitplatform.com.au/api/v2/health
```
...
**Check DNS:**
```bash
nslookup seo-expert.theprofitplatform.com.au
```
...
**Public URLs:**
- Dashboard: https://seo-expert.theprofitplatform.com.au/
- API Health: https://seo-expert.theprofitplatform.com.au/api/v2/health
- API Base: https://seo-expert.theprofitplatform.com.au/api/v2/
...
- [ ] Copied tunnel token
- [ ] Added public hostname: `seo-expert.theprofitplatform.com.au → localhost:9000`
...
2. **Multiple domains**: You can point multiple domains to the same service:
   - `seo-expert.theprofitplatform.com.au → localhost:9000`
...
5. **Check DNS**: `nslookup seo-expert.theprofitplatform.com.au`
