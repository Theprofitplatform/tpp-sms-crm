...
const DOMAIN = 'theprofitplatform.com.au';

const GSC_CREDENTIALS = {
  property_type: 'domain',  // DOMAIN property, not URL!
...
console.log('🔧 Configuring The Profit Platform with DOMAIN property...\n');
...
(async () => {
  try {
    ...
    if (success) {
      console.log('🎉 The Profit Platform GSC is now configured!');
      console.log('='.repeat(60));
      console.log('');
      ...
      console.log('');
      console.log('💡 Run this to fetch data now:');
      console.log('   node trigger-gsc-refresh.cjs');
    } else {
