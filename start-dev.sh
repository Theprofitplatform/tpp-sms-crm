...
echo ""
echo "Terminal 1 (API):"
echo "  cd /projects/sms-crm && source ./start-dev.sh && pnpm dev:api"
echo ""
echo "Terminal 2 (Worker):"
echo "  cd /projects/sms-crm && source ./start-dev.sh && pnpm dev:worker"
echo ""
echo "Terminal 3 (Web):"
echo "  cd /projects/sms-crm && pnpm dev:web"
echo ""
