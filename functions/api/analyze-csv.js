/**
 * Cloudflare Pages Function for CSV Analysis
 * Endpoint: /api/analyze-csv
 * 
 * This function handles CSV file uploads and analyzes position tracking data
 */
...
// ============================================
// CSV Analysis Functions (adapted from analyze-position-tracking.cjs)
// ============================================
...
function analyzePositionTracking(csvContent) {
  ...
  // Analyze declines - find the difference column dynamically
